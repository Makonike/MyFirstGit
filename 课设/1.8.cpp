...
void Del(StuPtr S){
    ...
    for(p1=S;p1->next;p1=p1->next){
        if(strcmp(tempID,p1->next->Stu_ID)==0){
            ...
            free(p2);
            p2=NULL;
            for(p2=S->next,i=0;p2;p2=p2->next,i++){
                if(!i){
                    Infile(p2,STUDENTS_RESIDUE,"w"); //  把删除后剩下的数据保存到文件 student1
                }else{
                    Infile(p2,STUDENTS_RESIDUE,"a+"); //  把删除后剩下的数据保存到文件 student1
                }
            }
            system("cls");
            printf("\n\n\n\n\n||->>                                            Delete successfully!");
...
Error:
    ...
    printf("                 ||                                                                                    ||\n");
    printf("                 ||                                  3.Search Top 3 by class                           ||\n");
    printf("                 ||                                                                                    ||\n");
    printf("                 ||                                  4.Search by scores                                ||\n");
    printf("                 ||                                                                                    ||\n");
...
Error_Scoreoption:
            ...
            printf("                 ||====================================================================================||\n");
            printf("                 ||                                                                                    ||\n");
            printf("                 ||                                 1.Search by Advanced Mathematics                   ||\n");
            printf("                 ||                                                                                    ||\n");
            printf("                 ||                                 2.Search by English                                ||\n");
            printf("                 ||                                                                                    ||\n");
            printf("                 ||                                 3.Search by Physical                               ||\n");
            printf("                 ||                                                                                    ||\n");
...
*************************************************/
void Stat2(StuPtr S){
    if(S->next->Total_Points==0){
        system("cls");
        printf("\n\n\n\n\n||->>                                            You haven't count yet, please sort and try again!");
        return;
    }
...
ErrorTeacher:
    while(1){
        ...
        printf("                 ||                                                                                    ||\n");
        printf("                 ||====================================================================================||\n");
        printf("                 ||                       1.Input Data               2.Show All                        ||\n");
        printf("                 ||                                                                                    ||\n");
        printf("                 ||                       3.Seek                     4.Statistics                      ||\n");
        printf("                 ||                                                                                    ||\n");
